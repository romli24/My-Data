...
<head>
    ...
    <title>My Data | Sampah Data Produk</title>
        ...
        <aside class="left-sidebar" data-sidebarbg="skin6">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    ...
                    <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                            href="{{route('keuntungan')}}" aria-expanded="false"><i class="me-3 fa mdi mdi-chart-bar"
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">Sampah Data Produk</h3>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="data-barang">Kembali</a></li>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="card">
                        ...
                        <a href="kembalikan_semua_sampah" class="btn btn-info mb-4 btn-sm">Pulihkan Semua Data</a>
                        <a href="hapus_permanen_semua_sampah" class="btn btn-warning mb-4 btn-sm">Hapus Permanen Semua Data</a>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img src="{{ asset('gambarproduk/' . $row->gambar) }}"
                                                                 style="width: 70px" class="img square">
                                                        <td>
                                                            <a href="/kembalikan_sampah/{{ $row->id }}" class="btn btn-success btn-sm mb-1">Pulihkan</a>
                                                            <a href="/hapus_permanen_sampah/{{ $row->id }}" class="btn btn-danger btn-sm"

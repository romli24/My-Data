...
<head>
    ...
    <title>My Data | Sampah Data Kategori</title>
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">Sampah Data Kategori</h3>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{route('kategori')}}">Kembali</a></li>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        <a href="kembalikan_semua_sampahh" class="btn btn-info mb-4 btn-sm">Pulihkan Semua Data</a>

                        <a href="hapus_permanen_semua_sampahh" class="btn btn-warning mb-4 btn-sm">Hapus Permanen Semua Data</a>
                            ...
                            <table class="table table-bordered">
                                    <thead>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $row->kategorii }}</td>
                                                <td>
                                                    <a href="/kembalikan_sampahh/{{ $row->id }}" class="btn btn-success btn-sm">Pulihkan</a>
                                                    <a href="/hapus_permanen_sampahh/{{ $row->id }}" class="btn btn-danger btn-sm"
...
<script>
    $('.delete').click(function() {
        ...
        swal({
                title: "Yakin?",
                text: "Kamu Akan Menghapus Semua Data Ini " + "",
                icon: "warning",
                buttons: true,
                dangerMode: true,
            })

...
<head>
    ...
    <title>My Data | Sampah Detail Pesanan</title>
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">Sampah Detail Pesanan</h3>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="/detail-pesanan/{{$kode}}">Kembali</a></li>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        <a href="kembalikan/semua/{{$kode}}" class="btn btn-info btn-sm mb-4">Pulihkan Semua</a>
                        <a href="hapus/permanen/semua/{{$kode}}" class="btn btn-warning btn-sm mb-4">Hapus Permanen Semua</a>
                                 ...
                                 <tbody>
                                    ...
                                    @foreach ($data as $row)
                                                <tr class="tr-shadow">
                                                    ...
                                                    <td>
                                                        <a href="/kembalikan/{{ $kode }}/{{ $row->id }} " class="btn btn-success btn-sm">Pulihkan</a>
                                                        <a href="/hapus_permanen/{{ $kode }}/{{ $row->id }}" class="btn btn-danger btn-sm">Hapus Permanen</a>
                                                    </td>
                                                </tr>
                                     @endforeach
                            </tbody>
